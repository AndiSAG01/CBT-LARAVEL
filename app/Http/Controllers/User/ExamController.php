...
class ExamController extends Controller
{
    public function index(Ujian $ujian)
    {
        ...
        $soals = Soal::where('kategori_id', $ujian->kategori_id)->paginate(10);
       ...
       $durasiUjian = $ujian->durasi;
       
        return view('user.Ujian.index', compact('ujian', 'user', 'allSoals', 'soals', 'answeredSoals', 'durasiUjian'));
    }
