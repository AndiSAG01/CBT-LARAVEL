                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_ujian" id="" class="form-control" placeholder=""
                                aria-describedby="helpId" value="{{ $ujian->tanggal_ujian }}" />
                                @error('tanggal_ujian')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_ujian" id="" class="form-control" placeholder=""
                                aria-describedby="helpId" value="{{ $ujian->jam_ujian }}" />
                                @error('jam_ujian')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="durasi" class="form-control" placeholder=""
                                aria-describedby="helpId" value="{{ $ujian->durasi }}" />
                                @error('durasi')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <tbody>
                        @foreach ($siswa as $sw)
                            <tr>
                                ...
                                <td class="p-4 border-b border-blue-gray-50">
                                    <input type="checkbox" class="pilihSiswa" name="siswa_id[]" value="{{ $sw->id }}"
                                        {{ in_array($sw->id, $ujian->siswa->toArray()) ? 'checked' : '' }}>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
