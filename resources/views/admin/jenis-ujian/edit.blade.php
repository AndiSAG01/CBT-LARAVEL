    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Jenis Ujian</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form id="editForm" action="{{ route('CategoryExam.update', $item->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <input type="text" name="user_id" id="" value="{{ $user }}">
                    <div class="form-group">
                        <label for="editName">Nama Jenis Ujian <i class="fas fa-book-reader"></i></label>
