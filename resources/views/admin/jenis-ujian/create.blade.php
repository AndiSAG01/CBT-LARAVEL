            ...
            <div class="container py-2">
                <x-card>
                    ...
                    <p class="font-normal text-white font-serif uppercase text-balance text-center">Pastikan Informasi
                        Data Jenis Ujian Di input dengan <span class="text-success">benar</span> untuk memastikan tidak terjadi
                        <span class="text-danger">kesalahan</span> informasi.
                    </p>
                </x-card>
            </div>
            <div class="modal-body">
                <form action="{{ route('CategoryExam.store') }}" method="post">
                    @csrf
                    <input type="text" name="user_id" id="" value="{{ $user }}" hidden>
                    <div class="form-group">
                        <label for="my-input">Nama Jenis Ujian <i class="fas fa-book-reader"></i></label>
