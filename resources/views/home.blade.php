...
<body style="background-image: url(/assets/images/foto3.png)">
    <nav class="navbar bg-primary navbar-expand-lg shadow-sm navbar-custom">
        <div class="container">
            ...
            <marquee style="font-family:'Times New Roman', Times, serif;" class="text-white"><b><h1>Selamat Datang Di Bimbel Kota Jambi</h1></b></marquee>
        </div>
    </nav>
                ...
                <div class="card" style="background-color: rgb(241, 241, 241)">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <p>
                                    <a href="{{ route('login.siswa') }}" class="btn btn-primary rounded"><i
                                            class="fas fa-user-graduate"></i> login siswa</a>
                                </p>
                                <p>
                                    <a href="{{ route('login') }}" class="btn btn-primary rounded"><i
                                            class="fas fa-chalkboard-teacher"></i> login guru</a>
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <img src="/assets/images/foto4.png" alt="" width="100px">
                            </div>
                        </div>
                       
                    </div>
                </div>
                <div class="card mt-2" style="background-color: rgb(241, 241, 241)">
                    <div class="card-header bg-primary">
            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>
                            {{ $tanggal }} | <i class="fas fa-user-tie"></i> Administator
                        </p>
                        <hr>
                    ...
                    <div class="card-body text-center">
                        <img src="/assets/images/foto1.png" alt="" width="800px">
                    </div>
                </div>
                <div class="card mt-2">
                    <div class="card-header">
                    ...
                    <div class="card-body text-center">
                        <img src="/assets/images/foto2.png" alt="" width="800px">
                    </div>
                </div>
            </div>
